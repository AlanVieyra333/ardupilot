...
Joystick::Joystick() {
  ...
  pwm_roll = copter.channel_roll->get_radio_trim();
  pwm_pitch = copter.channel_pitch->get_radio_trim();
  pwm_throttle = copter.channel_throttle->get_radio_trim();
  pwm_yaw = copter.channel_yaw->get_radio_trim();
  pwm_d = 1;
}
